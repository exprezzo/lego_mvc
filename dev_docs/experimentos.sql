...
-- ----------------------------
INSERT INTO `scrum_historias_de_usuario` VALUES ('1', 'ROOT', '0', '0', '1', null, null, '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('9', 'Backlog', '86', '3', '1', '0', 'asdf', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('11', 'Manual como el de Extjs4 o el mismo si es posible.', '88', '4', '1', '0', '<br>', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('17', 'DSA', '1', '3', '0', '9', null, '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('18', 'Mover historias de usuario entre sprints y backlog', '3', '1', '0', '1', '<br><ul><li><font color=\"0000FF\">Recargar el combo con la lista de sprints y el backlog en primer lugar, omitiendo la ubicacion actual</font></li><li>AL reubicar historia, reconfigurar la importancia</li></ul>', '3');
INSERT INTO `scrum_historias_de_usuario` VALUES ('24', 'Notificar al eliminar elementos, en comrportamiento grid y formulario', '87', '4', '1', '0', null, '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('26', 'Comportamiento Grid', '7', '4', '1', '6', 'al eliminar con Ã©xito, mostrar top message<br><ul><li>filtrar resultados</li><li><br></li></ul>', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('27', 'Al cambiar de proyecto, refrescar el tab activo', '1', '1', '1', '0', '', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('28', 'General', '30', '1', '1', '0', '<br>crear combo Status<br>', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('29', 'quiero crear Historias de usuario y gestionarlas', '0', '1', '0', '1', '<span style=\"color: rgb(51, 153, 102);\">crear catalogo de historias de usuario.<br><br><br></span><br><font color=\"0000FF\"><span style=\"background-color: rgb(255, 255, 255);\">quiero que el listado de historias de usuario diga </span><br style=\"background-color: rgb(255, 255, 255);\"><b style=\"background-color: rgb(255, 255, 255);\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Backlog</b><span style=\"background-color: rgb(255, 255, 255);\">:&nbsp; Historia X Ã³&nbsp; </span><br style=\"background-color: rgb(255, 255, 255);\"><span style=\"font-weight: bold; background-color: rgb(255, 255, 255);\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; sprint X</span><span style=\"background-color: rgb(255, 255, 255);\">: historia Y</span></font><br><br><font color=\"0000FF\">quiero priorizar las historias, moviendolas.</font><br><br>agregar categorias (sin subcategorias) al formulario y agregar filtro al\n grid, permitir multiseleccion para cambiar prioridad por grupo<br><br>agregar campos de historia adicionales de manera configurable (Â¿por proyecto?)<br><ul><li>Componentes</li><li>Solicitante</li><li>Bug tracking ID<br></li></ul>dividir historia<br><br>quiero que todos puedan crear historias, pero que solo el dueÃ±o de producto pueda agregarlas al backlog y al sprint.<br><br>quiero que las tareas notifiquen a los participantes del proyecto, de cambios (de estado principalmente), de creacion y de eliminacion.<br><br>', '6');
INSERT INTO `scrum_historias_de_usuario` VALUES ('30', 'Comportamiento Formulario', '11', '4', '0', '6', 'Al eliminar, el formulario debe quedar limpio, y se debe preguntar si cerrar.<br><br>El formulario debe notificar de cambios pendientes antes de cerrar.<br>', '1');
...
INSERT INTO `scrum_historias_de_usuario` VALUES ('36', 'que los usuarios puedan comentar acerca de las historias y tareas', '4', '1', '1', '0', '', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('37', 'Implementar roles de Scrum', '21', '1', '1', '0', '<br><font color=\"003366\" size=\"6\">Roles de Scrum.</font><br><br><b>DueÃ±o de producto:</b><br><br><b>Arbitro Scrum:</b><br><br><b>equipo de scrum:</b><br><br>', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('38', 'Implementar Reuniones de EstimaciÃ³n', '-1', '1', '1', '0', '<br>â€‹permitir reuniones sincronas y asincronas<br>', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('39', 'quiero crear tareas, y gestionarlas', '50', '1', '0', '1', 'crear catalogo de tareas, <br>', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('41', 'quiero crear Sprints y gestionarlos', '1', '1', '1', '0', '<br>agregar duracion del sprint<br><br>agregar fecha de inicio y fin<br><br>los sprints con fecha de inicio y fin se mostraran en el calendario<br><br><font color=\"FF0000\">en el catalogo no se borran los sprints</font><br><br>', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('42', 'Registrar las excepciones y el \"estack trace\"', '100', '2', '1', '0', '', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('44', 'quiero priorizar las historias.', '2', '1', '0', '1', '<br>( Tarea pasada a una historia con tareas relacionadas)<br>En el formulario, permitir agregar una cantidad numÃ©rica, <br><ul><li>impedir repetir la importancia a las historias del mismo padre, <br></li><li>establecer una prioridad por default (la mas baja)</li></ul><br>En el grid:<br><ul style=\"background-color: rgb(255, 255, 255);\"><li><font color=\"0000FF\">moverlas con flechas up-down;</font></li></ul><ul style=\"background-color: rgb(255, 255, 255);\"><li><font color=\"0000FF\">â€‹mantener seleccionada la historia, porque al moverla se selecciona siempre el primer elemento.</font></li></ul>', '6');
INSERT INTO `scrum_historias_de_usuario` VALUES ('45', 'SCRUM', '0', '1', '1', '0', '<br>Scrum es un comportamiento, para los involucrados en la creaciÃ³n de software.<br><br>EstÃ¡ Enfocado a resultados rÃ¡pidos y periÃ³dicos. <br><br>Establece reglas generales y roles, como en los juegos deportivos.<br><br><br><br>Un Sprint es un periodo de trabajo, recomendado entre 20 y 40 dias (confirmar).<br><br>En ese periodo de trabajo, se realizan tareas por el equipo de desarrollo.<br><br>Idealmente\n las tareas han sido seleccionadas y estimadas pero&nbsp; pueden crearse al \nvuelo teniendo presente que en ese periodo debe producirse un \nentregable.<br>', '2');
INSERT INTO `scrum_historias_de_usuario` VALUES ('47', 'el controlador debe manejar excepciones generales y propias del sistema.', '0', '2', '1', '0', '', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('48', 'el controlador debe reconocer cuando responder con ajax y cuando con html', '0', '2', '1', '0', '', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('55', 'en el panel principal, quiero mostrar un resumen del estado de las historias, tanto el backlog como en los sprints.', '0', '1', '1', '0', 'Al nodo backlog y a cada nodo de sprint, agregar un subnodo por cada estado, indicando el numero de tareas que se encuentran en ese estado.<br><br>Al darle click a un nodo, abrir el grid de historias de usuario filtrando por ese status.<br>', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('56', 'quiero agregar estados a las historias', '20', '1', '0', '1', 'form:<br><ul><li><font color=\"339966\">Agregar combo estado en el toolbar. (<span style=\"color: rgb(255, 0, 0);\">Incompleto</span>, solo funciona en edicion, no en nuevo)<br></font></li><li>&nbsp;desabilitado en nuevo <br></li><li>con estado por defaul seleccionado (desde configuracion).<br></li></ul><br>grid:<br><ul><li>agregar filtro por estados.<br></li></ul><ul><li>crear catalogo estados, <span style=\"font-weight: bold;\">nombre </span>estado, <span style=\"font-weight: bold;\">icono </span>(caja de texto para escribir ruta),&nbsp; <span style=\"font-weight: bold;\">descripcion </span>(para mostrar como ayuda talvez en tooltip), <span style=\"font-weight: bold;\">default </span>(boton togle en el toolbar, cuando no hay uno default, seleccionar automaticamente, cuando ya existe default, no presionar)<br></li></ul><br>Grid Estado:<br><ul><li>Basico.<br></li></ul>Form Estado:<br><ul><li>configurar un estado por default.</li></ul><br><br>', '6');
INSERT INTO `scrum_historias_de_usuario` VALUES ('57', 'Sprint 2', '0', '2', '0', '3', '', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('58', 'manejar modulos', '0', '2', '1', '0', '<br><br><font face=\"tahoma, arial, helvetica, sans-serif\"><span style=\"font-size: 12px;\">â€‹crear carpeta modulos, dentro de alli cada modulo con sus respectivos controladores, modelos y vistas.</span></font><br><font face=\"tahoma, arial, helvetica, sans-serif\"><span style=\"font-size: 12px;\">cada modulo tendria la estructura de la carpeta mvc, enconces las peticiones tendrian la forma:</span></font><br><br><b style=\"color: rgb(0, 0, 0); font-family: tahoma, arial, helvetica, sans-serif; font-size: 12px; \">MODULO/controlador/accion</b><br><br><ul><li><font face=\"tahoma, arial, helvetica, sans-serif\"><span style=\"font-size: 12px;\">crear pruebas unitarias</span></font></li></ul>', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('59', 'crear pruenas unitarias', '1', '1', '1', '0', '', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('60', 'Tener un sistema de mensajes centralizado, que tenga presente los lenguajes humanos', '99', '4', '1', '0', '', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('61', 'al cerrar el modulo, preguntar si desea cerrar los procesos abiertos por el modulo, y cerrarlos cuando eso se decida', '0', '4', '1', '0', '', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('62', 'agregar combo icon a los comportamientos', '0', '4', '1', '0', '', '1');
INSERT INTO `scrum_historias_de_usuario` VALUES ('85', 'reconfigurar la importancia.', '20', '1', '0', '1', '', '1');
...
INSERT INTO `sistema_menus` VALUES ('34', 'SCRUM', '23', 'Scrum', '', null);
